...
tmux split-window -v -p 66 python3 -m fastchat.serve.model_worker --model-names "gpt-3.5-turbo,text-davinci-003,text-embedding-ada-002,Llama-2-13b-german" --model-path jphme/Llama-2-13b-chat-german --host 0.0.0.0
